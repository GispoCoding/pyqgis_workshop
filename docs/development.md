Development of TestPlugin plugin
===========================
...
`git clone --recurse-submodules https://github.com/GispoCoding/testplugin.git`


The code for the plugin is in the [TestPlugin](../TestPlugin) folder. Make sure you have required tools, such as
Qt with Qt Editor and Qt Linquist installed by following this
[tutorial](https://www.qgistutorials.com/en/docs/3/building_a_python_plugin.html#get-the-tools).

For building the plugin use platform independent [build.py](../TestPlugin/build.py) script.
...
* they contain relative imports
    ...
    from TestPlugin.utils.exceptions import TestException # Bad
    ```
* they will be found by [build.py](../TestPlugin/build.py) script (`py_files` and `ui_files` values)
* you consider adding test files for the new functionality

## Deployment

Edit [build.py](../TestPlugin/build.py) to contain working values for *profile*, *lrelease* and *pyrcc*.
...
* Add this badge ![](https://github.com/GispoCoding/testplugin/workflows/Translations/badge.svg) to the [README](../README.md)
...
The translation files are in [i18n](../TestPlugin/resources/i18n) folder.
